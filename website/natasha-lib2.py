...
from extractor.structure.resume import Resume
from natasha import (
    Segmenter,
    MorphVocab,
...
def main():
    ...
    resume_names = ['Резюме_data_analyst_Андреи_Козлов.pdf', 'Perl-программист.pdf', 'марина_лалала_резюме.pdf', 'Михаил Васильев.pdf',
    ...
    resume = Resume(text)
    # for ent in resume.education.ents:
    #     print(ent.text)
